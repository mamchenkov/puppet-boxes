class nginx {
	...
	$install_packages = $operatingsystem ? {
		Amazon => ['nginx', 'php55-fpm', 'mysql55', 'php55-cli', 'php55-pdo', 'php55-mysqlnd', 'php55-soap', 'php55-xml', 'php55-gd', 'php55-mbstring', 'php55-mcrypt'],
		default => ['nginx', 'php-fpm', 'mysql', 'php-cli', 'php-pdo', 'php-mysqlnd', 'php-soap', 'php-xml', 'php-gd', 'php-mbstring', 'php-mcrypt'],
	}
